const enCommon = {
  ...
  addDialog: {
    title: "Add a copy",
    lede: "Each format is its own entry, so you can own the same record twice.",
    tab: {
      SEARCH: "Search",
      BARCODE: "Barcode",
      CSV: "Import CSV",
...
const deCommon: CommonSchema = {
  ...
  addDialog: {
    ...
    lede: "Jedes Format ist ein eigener Eintrag — dieselbe Platte kannst du doppelt besitzen.",
    tab: {
      SEARCH: "Suche",
      BARCODE: "Barcode",
      CSV: "CSV importieren",
